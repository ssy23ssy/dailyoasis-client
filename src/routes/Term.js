...
class Term extends Component {
  render() {
    return (
      <div>
        <MiniHeader title="이용약관" />
        <div style={style}>
          제1조(목적)
          <br />
          데일리오아시스 서비스 이용약관은 회원이 회사에서 제공하는 인터넷 관련 서비스를 이용함에 있어 회원과 회사 간의 권리, 의무 및 책임 사항 등을 규정함을 목적으로 합니다.
          <br />
          <br />
          <br />
          제2조(정의)
          ...
          <br />
          2. "서비스"란, 데일리오아시스가 제공하는 서비스를 말합니다. 서비스는 정보통신설비를 이용하여 재화 및 용역을 거래할 수 있도록 설정한 가상의 영업장을 포함합니다. 서비스는 각 서비스 내부에서 보여지는 게시물, 기능, 재화, 용역 등을 모두 포함하며, 이와 관련된 사항과 정보 또한 모두 포함합니다.
          <br />
          ...
          <br />
          7. "모든 약관"이란, 데일리오아시스 서비스 이용약관, 데일리오아시스 개인정보처리방침 등 회사와 회원이 계약한 모든 약관을 말합니다.
          <br />
          <br />
          <br />
          제3조(약관의 게시와 개정)
          <br />
          1. 회사는 회사의 모든 약관과 법령에 따라 명시해야 하는 정보가 있을 경우, 서비스 하단 > setting > 이용약관 등에 게시할 수 있습니다.
          <br />
          2. 회사는 관련법을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다.
          <br />
          3. 만약 개정내용이 회원에게 불리한 경우, 적용 일자 7일 이전부터 적용 일자 전일까지 데일리오아시스 웹사이트 공지사항에 공지합니다.
          <br />
          4. 회사가 제2항에 따라 개정 약관을 공지한 후, 회원이 7일 이내에 명시적으로 거부 의사 표시를 하지 않은 경우 회원이 개정 약관에 동의한 것으로 간주합니다.
          <br />
          ...
          <br />
          4. 회사는 회원의 개인정보 및 서비스 이용 기록(학교, 학과, 학번 등)에 따라 서비스 이용에 차이를 둘 수 있습니다.
          <br />
          ...
          <br />
          4. 회원은 다음 행위를 할 수 없습니다. 회원이 다음 행위를 할 경우 회사는 회원의 자격을 적절한 방법으로 제한 및 정지, 상실 시킬 수 있습니다.
          <br />
          ...
          - 허가되지 않은 상업적 행위
          <br />
          - 개인정보처리방침 등 회원이 동의한 모든 약관에 대해 따르지 않는 행위
          <br />
          ...
          <br />
          3. 회원이 7일 이내에 의사 표시를 하지 않은 경우, 회원이 통지 내용에 대해 동의한 것으로 간주합니다.
          <br />
          <br />
          <br />
          ...
          <br />
          5. 회사는 점검, 고장, 교체, 변경, 품절 등의 불가피한 사유가 발생한 경우, 서비스 및 약정을 일시적 및 영구적으로 보류 및 중단할 수 있으며, 약정의 내용을 대체하거나 회원의 동의에 따라 약정을 파기할 수 있습니다. 회원이 회사에 대금을 지급한 약정이 파기될 경우, 회사는 파기 시점으로부터 3일 이내에 지급받은 대금을 환급합니다.
          <br />
          6. 서비스 변경 및 중단의 경우에는 제6조에서 정한 방법을 통해 통지합니다. 다만 회사가 통제할 수 없는 사유로 서비스가 중단되어 통지가 불가능한 경우에는 통지하지 않습니다.
          <br />
          7. 회사는 서비스의 변경, 중지로 발생하는 문제에 관하여 어떠한 책임도 지지 않습니다. 
          <br />
          8. 회사는 컴퓨터 등 정보통신설비의 보수점검·교체 및 고장, 통신 두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할 수 있고, 새로운 서비스로의 교체를 회사가 적절하다고 판단하는 사유에 의하여 현재 제공되는 서비스를 완전히 중단할 수 있습니다.
          <br />
          <br />
          <br />
          제8조(회사의 의무)
          ...
          <br />
          2. 회사는 유용하고 편리한 서비스를 제공하기 위해, 서비스 내부의 기능(의 체계와 다양한 부가기능을 직접 설계 및 운영하고 있는 데이터베이스 제작자에 해당합니다. 회사는 저작권법에 따라 데이터베이스 제작자는 복제권 및 전송권을 포함한 데이터베이스 전부에 대한 권리를 가지고 있으며, 이는 법률에 따라 보호를 받는 대상입니다. 그러므로 회원 또는 사이트 접속자는 데이터베이스 제작자인 회사의 승인 없이 데이터베이스의 전부 또는 일부를 복제·배포·방송 또는 전송할 수 없습니다.
          <br />
          ...
          제10조(게시물 및 커뮤니티의 관리)
          <br />
          1. 회원이 관련법 및 각 약관에 위배되는 내용의 커뮤니티를 개설하거나 게시물을 게시할 경우, 회사는 회원의 동의없이 해당 서비스, 커뮤니티 또는 게시물을 임의로 삭제, 중단, 변경 등의 조치를 할 수 있고 회원의 자격 및 권한을 제한, 정지 및 박탈할 수 있습니다.
          <br />
          ...
          <br />
          3. 다음 목록에 해당하는 내용을 포함하는 ‘동아리’의 게시와 ‘댓글’ 작성을 금지하고 있습니다. 다음 각 호에 해당하는 경우 회사는 회원에게 사전 통지 없이 해당 내용을 삭제할 수 있고, 해당 회원의 회원 자격을 제한, 정지 또는 상실시킬 수 있습니다. 
          <br />
          ...
          <br />
          - 허가되지 않은 광고/홍보물 또는 상업적/상업체 연관 게시물(타 서비스 및 사이트, 공동구매, 이벤트, 티켓판매, 참가비, 구인 등)
          <br />
          - 허가되지 않은 기부금품 모집 게시물
          <br />
          ...
          - 기타 부적합한 게시물
          <br />
          - 사회 일반의 도덕 관념에 위반되는 내용의 정보, 문장, 도형 등을 유포하는 내용
          <br />
          - 범죄행위와 관련이 있다고 판단되는 내용
          <br />
          - 회사의 이익을 저해하는 내용
          <br />
          - 타인의 ID, 성명 등을 무단으로 도용하여 작성한 내용이거나, 타인이 입력한 정보를 무단으로 위, 변조한 내용인 경우
          <br />
          <br />
          4. 신고 제도
          <br />
          - 커뮤니티 이용 규칙에 어긋난다고 생각하는 게시물은 신고 버튼을 이용하여 신고해주시기 바랍니다.
          <br />
          - 모든 신고는 약관에 의한 정확한 심의를 거쳐 처리됩니다. 회원의 요청에 따라 게시물을 삭제하지 않습니다.
          <br />
          ...
          <br />
          <br />
          5. 허위사실 유포 및 명예훼손 게시물에 대한 게시중단 요청
          <br />
          - 허위사실 유포 및 명예훼손 등 권리를 침해하는 게시물의 게시중단을 원하실 경우, (qkrwotjd1445@naver.com)의 이메일을 통해 게시중단 요청을 전달주시기 바랍니다.
          <br />
          ...
          제16조(부칙)
          <br />
          - 이 약관은 2019년 3월부터 적용되었고, 2018년 3월 3일에 최신화 되었습니다.
          <br />
